...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error)) {
        $code = substr(str_shuffle("ABCDEFGHT123456789"), 0, 4);  // Generate code
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO users (fname, sname, mobile_number, email, username, password, code) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <link rel="stylesheet" href="style-create-users.css">
