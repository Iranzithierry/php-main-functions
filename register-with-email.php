...
include('conn.php');
include_once('header-register.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen(trim($_POST["number"])) < 10) {
    ...
    if (empty($error)) {
        ...
        try {
            ...
            $mail->Body    = 'Here Is The Verification Link <b><a href="http://localhost/Champion%20Earn/?verification='.$code.'">http://localhost/Champion%20Earn/?verification='.$code.'</a></b>';
        ...
        echo "</div>";
        $succes =  "We've Sent A Verification Link To " . $email . ".";
            ...
            <div class="input-field">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="form">
                    <div class="register-form">
                        <div class="input">
                            <label for="email">Fast Name</label><br>
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="sname" id="input-field" placeholder="Enter Your Second Name" value="<?php echo htmlspecialchars($sname) ?>">
                        </div>


                        <div class="input number">
                            <label for="number">Enter Yor Number</label>
                            <br>
                            <input type="number" name="number" pattern="[0-9]{10}" id="input-field" placeholder="Enter Valid Number" maxlength="9">
                        </div>
